...
//             >
//               <input type="checkbox" id={`star-${star}`} value={star} />
//               <label
//                 htmlFor={`star-${star}`}
//                 style={{ color: "gold", fontSize: "18px", marginLeft: "8px" }}
//               >
//                 {"★".repeat(star)}
//               </label>
//             </div>
...
//         <p>
//           <label>
//             <input type="radio" name="delivery" /> Any
//           </label>
//         </p>
//         <p>
//           <label>
//             <input type="radio" name="delivery" /> Up to 2 days
//           </label>
//         </p>
//         <p>
//           <label>
//             <input type="radio" name="delivery" /> Up to 5 days
//           </label>
//         </p>
...
//         <div className="sort">Sort by popularity ▼</div>

//         <div className="product-grid">
//           {filtered.length === 0 ? (
//             <p>No products in selected range.</p>
//           ) : (
//             filtered.map((item) => (
//               <div className="product-card" key={item._id}>
//                 <img
//                   src="http://localhost:5000/images/p1.PNG"
//                   alt="Product"
